...
class InteractiveTree {
    ...
    initVis() {
        ...
        var svg = d3.select("#interactiveTree").append("svg")
            .attr("width", width)
            .attr("class", "collapsible-svg")
            .append("g")
        ...
        function update(source) {
            ...
            d3.select(".collapsible-svg").transition()
                .duration(duration)
                .attr("height", height);
...
// Toggle children on click.
        ...
        function color(d) {
            ...
            return d._children ? "#3182bd" : d.children ? "#c6dbef" : "#34a0a4";
        }
    }
